...
This script can be used to tune the parameters of the network.
The import stage, net architecture and the simulation stage are separated 
to allow for easy tuning of the network without the need to redefine all objects every iteration.
'''
