...
Tests out Temporal Contrast spike encoding strategies using sample data 
imported from a single subject for a single movement.
Can display spike encoding and signal reconstruction.
"""
#%%
import numpy as np
