...
set(Qt5MacExtras_VERSION_STRING 5.9.7)
...
if (NOT TARGET Qt5::MacExtras)
    ...
    set(_Qt5MacExtras_OWN_INCLUDE_DIRS "${_qt5MacExtras_install_prefix}/include/qt/" "${_qt5MacExtras_install_prefix}/include/qt/QtMacExtras")
    set(Qt5MacExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5MacExtras_install_prefix}/include/qt/QtMacExtras/5.9.7"
        "${_qt5MacExtras_install_prefix}/include/qt/QtMacExtras/5.9.7/QtMacExtras"
    )
    ...
    # specified.
    list(FIND Qt5MacExtras_FIND_COMPONENTS Private _check_private)
    if (NOT _check_private STREQUAL -1)
        foreach(_dir ${Qt5MacExtras_PRIVATE_INCLUDE_DIRS})
            _qt5_MacExtras_check_file_exists(${_dir})
        endforeach()
    endif()
    ...
    foreach(_module_dep ${_Qt5MacExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.7 ${_Qt5MacExtras_FIND_VERSION_EXACT}
    ...
    _populate_MacExtras_target_properties(RELEASE "libQt5MacExtras.5.9.7.dylib" "" )
